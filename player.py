...
# Create Playlist Box
myFont = font.Font(family='Baloo')
playlist_box = Listbox(main_frame, bg="black", fg="white", width=60, selectbackground="white", selectforeground='black', font=myFont)
